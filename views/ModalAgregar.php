...
?>
        ...
        <form id="formAgregarStock" method="POST">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary btnGuardarMasStock" value="<?php echo $idProd; ?>">Guardar</button>
            </div>
        </form>

        <?php } elseif ($act == 'quitar') {
        ...
        ?>
            <form id="formQuitarStock" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        <button type="submit" class="btn btn-primary btnGuardarMenosStock" value="<?php echo $idProd; ?>">Guardar</button>
                    </div>
                </div>
            </form>
